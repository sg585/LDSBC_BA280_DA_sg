...
DROP FUNCTION [dbo].[udf_strip_non_numeric]
GO
...
CREATE FUNCTION [dbo].[udf_strip_non_numeric]
(@Temp VARCHAR(1000)
)
...
/*****************************************************************************************************************
NAME:    dbo.udf_strip_non_numeric
PURPOSE: Remove non numeric characters from a string
MODIFICATION LOG:
